<template>
  <div class="chains">
    ...
    <p v-if="!editing" class="ch-note">
      Цепочки появляются в «Прокси-узлы» как <b>🔗 &lt;имя&gt;</b> — выбери их как обычный сервер. Узлы должны существовать в активной подписке. UDP через relay работает не на всех протоколах.
    </p>
  </div>
</template>
