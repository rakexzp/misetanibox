...
export function setConsoleBg(dataUrl: string) {
  globalState.consoleBg = dataUrl || '';
}
...
export const globalState = reactive({
  ...
  consoleBg: '' as string, // пользовательский фон экрана Консоль (data-URI), грузится с бэкенда
