...
/**
 * Quick Settings tile (шторка / панель переключателей),
 * как у ByeByeDPI / Happ: тап — вкл/выкл VPN.
 */
class VpnTileService : TileService() {
    ...
    private fun openApp(requestVpn: Boolean = false) {
